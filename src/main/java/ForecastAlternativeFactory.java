 ...
 * @author WatPowerUser
 */
public class ForecastAlternativeFactory extends AbstractNewObjectFactory  implements NewObjectFactory{
    private ForecastGeneratorPlugin _plugin;
    public ForecastAlternativeFactory(ForecastGeneratorPlugin plugin){
        super(ForecastGeneratorI18n.getI18n(ForecastGeneratorMessages.Bundle_Name));
        _plugin = plugin;
    }
    @Override
    ...
    public Object createObject(JComponent jc) {
        ...
        ForecastGeneratorAlternative alt = new ForecastGeneratorAlternative();
